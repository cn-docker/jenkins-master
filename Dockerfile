...
RUN echo 2.60.1 > /usr/share/jenkins/ref/jenkins.install.UpgradeWizard.state && \
    echo 2.60.1 > /usr/share/jenkins/ref/jenkins.install.InstallUtil.lastExecVersion